...
### **NACH JEDEM FEHLER ZWINGEND:**

1. **AAR (After Action Review):** Was ging schief?
2. **Root-Cause-Analysis:** Warum passierte es?
3. **Reverse Engineering:** Wie hätte verhindert werden können?
4. **Lesson Learned:** Dokumentation in docs/lessons-learned/
5. **Prevention:** Konkrete Maßnahme implementieren
...
- **Widersprüchliches Verhalten:** Scope-System predigen aber nicht befolgen
- **Token-Blindheit:** Arbeiten trotz Kontextlimit-Überschreitung

#### **ROOT-CAUSES IDENTIFIZIERT:**

- **Veraltete Instructions:** Falsche Pfadangaben (docs/ideen/ existiert nicht)
- **Widersprüchliche Regeln:** Dateierstellung-Verbote vs. Erlaubnisse
- **Unvollständiger VS Code Kontext:** Wichtige Instructions fehlen in templateFiles
...
_Diese TODO-Liste ist die EINZIGE Quelle der TODO-Wahrheit und wird täglich aktualisiert._
