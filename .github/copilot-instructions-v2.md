...
- **[💪 Produktivitäts-Coaching](instructions/coaching/produktivitaet.md)** - Anti-Verzettlung, Fokus-Hilfe
- **[🧠 Mini-Coaching System](instructions/coaching/anti-konfusion.md)** - Clarity-Checks
...
- **Zielgruppe:** IT-Professionals mit Rechtsproblemen
- **Simon's Expertise:** 5 Jahre IT (Helpdesk → Sysadmin → IT-Beratung) bei Siemens/Yunex
- **Content-Authentizität:** ZWINGEND Simon's echte Stimme bewahren

### **🎨 DESIGN-SYSTEM:**

- **Farbschema:** 60/30/10+ Flex-System (asphaltschwarz, stormy-blue, accent-colors)
...
**🎯 MAIN GOAL:** Authentische, professionelle Website für Simon's Rechtsberatung - OHNE Chaos!
