...
**Erstellt:** 29.7.2025, 10:41:01  
**Analysedauer:** 0.18 Sekunden  
...
|--------|------|
| **Dateien gesamt** | 103 |
| **Zeilen gesamt** | 56’412 |
| **Wörter gesamt** | 291’204 |
| **Zeichen gesamt** | 4’619’170 |
| **Geschätzte Tokens** | 2’413’462 |
...
|-------|---------|--------|--------|-----------|
| **DOCUMENTATION** | 80 | 47’443 | 326’738 | 4084 |
| **CONTENT** | 78 | 44’401 | 313’061 | 4014 |
| **BUILD_SYSTEM** | 71 | 46’006 | 298’569 | 4205 |
| **TODOS_MANAGEMENT** | 57 | 43’749 | 284’033 | 4983 |
| **CSS_DESIGN** | 53 | 42’172 | 271’600 | 5125 |
| **INSTRUCTIONS** | 54 | 38’908 | 241’042 | 4464 |
| **CONFIG** | 36 | 38’166 | 238’618 | 6628 |
| **ASSETS** | 20 | 36’389 | 238’326 | 11916 |
| **ASTRO_COMPONENTS** | 27 | 32’607 | 201’475 | 7462 |
...
**Zu viele Dateien für Auflistung** (88 Dateien)
...
### 1. ⚠️ Scope BUILD_SYSTEM hat 298569 Tokens (>10k Limit)
...
### 2. ⚠️ Scope CONFIG hat 238618 Tokens (>10k Limit)
...
### 3. ⚠️ Scope CSS_DESIGN hat 271600 Tokens (>10k Limit)
...
### 4. ⚠️ Scope INSTRUCTIONS hat 241042 Tokens (>10k Limit)
...
### 5. ⚠️ Scope TODOS_MANAGEMENT hat 284033 Tokens (>10k Limit)
...
### 6. ⚠️ Scope DOCUMENTATION hat 326738 Tokens (>10k Limit)
...
### 7. ⚠️ Scope CONTENT hat 313061 Tokens (>10k Limit)
...
### 8. ⚠️ Scope ASTRO_COMPONENTS hat 201475 Tokens (>10k Limit)
...
### 10. 🚨 Gesamtprojekt hat 2413462 Tokens (>50k GitHub Copilot Limit)
