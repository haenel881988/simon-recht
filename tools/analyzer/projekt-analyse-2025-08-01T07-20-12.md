...
- `tools/analyzer/universal-project-analyzer.cjs` (BUILD_SYSTEM, 4584 Tokens)
...
| `docs/todos/todos_neu.md` | TODOS_MANAGEMENT | DOCUMENTATION | Datei gehört besser zu DOCUMENTATION |
...
### 1. ⚠️ Scope BUILD_SYSTEM hat 104303 Tokens (>10k GLOBAL LIMIT)
...
### 2. ⚠️ Scope CONFIG hat 51534 Tokens (>10k GLOBAL LIMIT)
...
### 3. ⚠️ Scope CONTENT hat 110545 Tokens (>10k GLOBAL LIMIT)
...
### 4. ⚠️ Scope INSTRUCTIONS hat 40134 Tokens (>10k GLOBAL LIMIT)
...
### 5. ⚠️ Scope DOCUMENTATION hat 125204 Tokens (>10k GLOBAL LIMIT)
...
### 6. ⚠️ Scope CSS_DESIGN hat 81219 Tokens (>10k GLOBAL LIMIT)
...
### 7. ⚠️ Scope TODOS_MANAGEMENT hat 85788 Tokens (>10k GLOBAL LIMIT)
...
### 10. 🚨 Gesamtprojekt hat 686026 Tokens (>50k GitHub Copilot Limit)
