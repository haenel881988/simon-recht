...
**Erstellt:** 29.7.2025, 11:23:40  
**Analysedauer:** 0.17 Sekunden  
...
|--------|------|
| **Dateien gesamt** | 98 |
| **Zeilen gesamt** | 57’632 |
| **Wörter gesamt** | 291’745 |
| **Zeichen gesamt** | 4’625’865 |
| **Geschätzte Tokens** | 2’457’535 |
...
|-------|---------|--------|--------|-----------|
| **DOCUMENTATION** | 75 | 48’663 | 327’438 | 4366 |
| **CONTENT** | 73 | 45’621 | 313’761 | 4298 |
| **BUILD_SYSTEM** | 70 | 47’626 | 305’827 | 4369 |
| **TODOS_MANAGEMENT** | 54 | 45’311 | 287’766 | 5329 |
| **CSS_DESIGN** | 55 | 44’243 | 282’386 | 5134 |
| **CONFIG** | 40 | 40’078 | 248’386 | 6210 |
| **INSTRUCTIONS** | 50 | 40’277 | 242’402 | 4848 |
| **ASSETS** | 20 | 36’389 | 238’326 | 11916 |
| **ASTRO_COMPONENTS** | 31 | 34’519 | 211’243 | 6814 |

---

## 🔗 SCOPE-ÜBERLAPPUNGEN

### 1. ASSETS + ASTRO_COMPONENTS + BUILD_SYSTEM + CONFIG + CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 2. ASTRO_COMPONENTS + BUILD_SYSTEM + CONTENT + CSS_DESIGN + DOCUMENTATION
...
### 4. BUILD_SYSTEM + CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
**Zu viele Dateien für Auflistung** (18 Dateien)

### 5. CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 7. CONTENT + CSS_DESIGN + DOCUMENTATION + TODOS_MANAGEMENT
...
### 8. ASSETS + CONTENT + CSS_DESIGN + DOCUMENTATION
...
### 9. BUILD_SYSTEM + CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS
...
### 10. BUILD_SYSTEM + CONTENT + CSS_DESIGN + DOCUMENTATION
...
### 11. CONTENT + CSS_DESIGN + DOCUMENTATION
...
### 13. ASSETS + ASTRO_COMPONENTS + CONTENT + CSS_DESIGN
...
### 14. ASTRO_COMPONENTS + CONTENT + CSS_DESIGN
...
### 15. ASTRO_COMPONENTS + BUILD_SYSTEM + CONTENT + CSS_DESIGN
...
### 16. ASSETS + ASTRO_COMPONENTS + BUILD_SYSTEM + CONTENT + CSS_DESIGN
...
### 17. ASTRO_COMPONENTS + BUILD_SYSTEM + CONFIG + CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
**Zu viele Dateien für Auflistung** (120 Dateien)

### 18. BUILD_SYSTEM + CONTENT + CSS_DESIGN + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 19. BUILD_SYSTEM + CONFIG + CONTENT + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 20. BUILD_SYSTEM + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 21. ASSETS + ASTRO_COMPONENTS + BUILD_SYSTEM + CONFIG + CSS_DESIGN + DOCUMENTATION + INSTRUCTIONS + TODOS_MANAGEMENT
...
### 1. ⚠️ Scope CONTENT hat 313761 Tokens (>10k Limit)
...
### 2. ⚠️ Scope TODOS_MANAGEMENT hat 287766 Tokens (>10k Limit)
...
### 3. ⚠️ Scope BUILD_SYSTEM hat 305827 Tokens (>10k Limit)
...
### 4. ⚠️ Scope DOCUMENTATION hat 327438 Tokens (>10k Limit)
...
### 5. ⚠️ Scope CONFIG hat 248386 Tokens (>10k Limit)
...
### 6. ⚠️ Scope CSS_DESIGN hat 282386 Tokens (>10k Limit)
...
### 7. ⚠️ Scope INSTRUCTIONS hat 242402 Tokens (>10k Limit)
...
### 8. ⚠️ Scope ASTRO_COMPONENTS hat 211243 Tokens (>10k Limit)
...
### 10. 🚨 Gesamtprojekt hat 2457535 Tokens (>50k GitHub Copilot Limit)
