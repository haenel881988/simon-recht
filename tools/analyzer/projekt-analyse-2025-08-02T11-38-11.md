...
|--------|------|
| **Dateien gesamt** | 87 |
| **Zeilen gesamt** | 19’478 |
| **Wörter gesamt** | 84’236 |
| **Zeichen gesamt** | 826’528 |
| **Geschätzte Tokens** | 109’542 |
...
|-------|---------|--------|--------|-----------|
| **ANALYZER_TOOLS** | 18 | 9’077 | 29’764 | 1654 |
...
### 3. ⚠️ Scope ANALYZER_TOOLS hat 29764 Tokens (>10k GLOBAL LIMIT)
...
### 4. 🔔 Projekt-Total: 109542 Tokens (KI-Work-Context: 27394 = 25%)
...
- **Projekt-Total:** 109’542 Tokens (inkl. irrelevante Bilder/Research)
- **KI-Work-Relevant:** 27’394 Tokens (25% des Projekts)
- **Filtered Out:** Bilder, Research-Docs, Archive (82’148 Tokens)
...
| `tools/analyzer/universal-project-analyzer.cjs` | 5174 | 1434 | ANALYZER_TOOLS |
