...
|--------|------|
| **Dateien gesamt** | 102 |
| **Zeilen gesamt** | 78’939 |
| **Wörter gesamt** | 432’761 |
| **Zeichen gesamt** | 8’698’360 |
| **Geschätzte Tokens** | 4’095’649 |
...
|-------|---------|--------|--------|-----------|
| **DOCUMENTATION** | 76 | 69’550 | 509’347 | 6702 |
| **CONTENT** | 74 | 66’297 | 494’887 | 6688 |
| **BUILD_SYSTEM** | 74 | 69’176 | 489’407 | 6614 |
| **TODOS_MANAGEMENT** | 57 | 66’573 | 470’626 | 8257 |
| **CSS_DESIGN** | 62 | 65’841 | 467’102 | 7534 |
| **CONFIG** | 50 | 63’389 | 439’094 | 8782 |
| **INSTRUCTIONS** | 57 | 61’802 | 426’289 | 7479 |
| **ASTRO_COMPONENTS** | 40 | 56’959 | 399’945 | 9999 |
...
**Betroffene Dateien:**
- `docs/todos/todos.md` (2318 Tokens)
- `docs/todos/todos.md` (2318 Tokens)
- `docs/todos/todos.md` (2318 Tokens)
- `docs/todos/todos.md` (2318 Tokens)
- `docs/todos/todos.md` (2318 Tokens)
...
**Zu viele Dateien für Auflistung** (208 Dateien)
...
### 1. ⚠️ Scope BUILD_SYSTEM hat 489407 Tokens (>10k Limit)
...
### 2. ⚠️ Scope CONFIG hat 439094 Tokens (>10k Limit)
...
### 3. ⚠️ Scope CSS_DESIGN hat 467102 Tokens (>10k Limit)
...
### 4. ⚠️ Scope INSTRUCTIONS hat 426289 Tokens (>10k Limit)
...
### 5. ⚠️ Scope TODOS_MANAGEMENT hat 470626 Tokens (>10k Limit)
...
### 6. ⚠️ Scope DOCUMENTATION hat 509347 Tokens (>10k Limit)
...
### 7. ⚠️ Scope CONTENT hat 494887 Tokens (>10k Limit)
...
### 9. ⚠️ Scope ASTRO_COMPONENTS hat 399945 Tokens (>10k Limit)
...
### 10. 🚨 Gesamtprojekt hat 4095649 Tokens (>50k GitHub Copilot Limit)
